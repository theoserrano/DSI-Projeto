        ...
        <View style={[styles.card, { backgroundColor: theme?.colors.background }]}> 
          <View style={styles.topRow}>
            ...
            <View style={styles.titleArea}>
              ...
              {artist ? <Text style={[styles.artistText, { color: theme?.colors.text }]} numberOfLines={1}>{artist}</Text> : null}
...
const styles = StyleSheet.create({
  ...
  coverLeft: { width: 92, height: 92, borderRadius: 10, marginRight: 12, borderWidth: 2, borderColor: '#fff' },
  titleArea: { flex: 1 },
  ...
  send: { marginTop: 16, alignSelf: 'center', paddingVertical: 12, paddingHorizontal: 36, borderRadius: 24 },
});
